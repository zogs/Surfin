(function() {
    ...
    let defaults = {
      ...
      waves: {
        ...
        obstacles: [
              ...
              {name:'Toruk', tmin:0, tmax:0, interval:8000, intervalMax:18000 },
  ...
  var prototype = createjs.extend(Pandora3, window.Spot);

  SPOTS.Pandora3 = Pandora3;
  LEVELS.push(Pandora3);
